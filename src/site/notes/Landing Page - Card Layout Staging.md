...
### Image Placeholders
Replace these with actual preview images:
- `/img/placeholder-busbar.png` → screenshot or diagram of busbar calculator
- `/img/placeholder-handcalc.png` → screenshot of handcalc output
- `/img/placeholder-cooling.png` → photo from cooling test setup

### Image Location
Images should go in: `src/site/img/` folder for Digital Garden

### Alternative: Obsidian Embeds
If you prefer Obsidian-style embeds instead of HTML img tags:
```markdown
![[busbar-preview.png]]
```

### Link Paths
The `href` values need to match your actual Digital Garden permalinks. Current guesses based on note names - verify these match.
